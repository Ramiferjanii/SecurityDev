...
export function PlaceholdersAndVanishInput({
  ...
  const inputValue = propValue !== undefined ? propValue : localValue;
  ...
  const vanishAndSubmit = () => {
    ...
    // Check propValue first if controlled
  ...
  // Decide whether to render as Form or Div
  const Tag = (onSubmit ? "form" : "div") as any;
  ...
  return (
    <Tag
      className={cn(
        ...
        // Additional class to ensure it works in layout
        "flex items-center" 
      )}
    ...
    >
      ...
      <input
        ...
        className={cn(
          ...
          // Adjusted right padding if no submit button
          onSubmit ? "pr-20" : "pr-4",
